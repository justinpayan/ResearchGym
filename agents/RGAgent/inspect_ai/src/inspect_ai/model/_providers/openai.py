...
class OpenAIAPI(ModelAPI):
    def __init__(
        ...
        **model_args: Any,
        ...
        if self.is_azure():
            ...
            # azure_rest = f"{base_root}/openai/v1"
    ...
    def completion_params(self, config: GenerateConfig, tools: bool) -> dict[str, Any]:
        ...
        # Permit reasoning_effort for GPT models as well; continue to exclude
        # o1-mini and o1-preview which do not support this parameter.
        if (
