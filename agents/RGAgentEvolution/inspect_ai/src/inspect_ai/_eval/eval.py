...
def eval_init(
    ...
    **kwargs: Unpack[GenerateConfigArgs],
    ...
    # resolve models
    # Remove unsupported/undesired params before constructing GenerateConfig.
    # The calling code may pass reasoning_tokens; we explicitly ignore it.
    if "reasoning_tokens" in kwargs:
        try:
            del kwargs["reasoning_tokens"]
        except Exception:
