...
def usage_metadata_to_model_usage(
    ...
    # According to Google's API docs, the field is 'cached_content_token_count'
    # https://ai.google.dev/gemini-api/docs/caching?lang=python
    cached_content_token_count = getattr(metadata, 'cached_content_token_count', None) or 0
