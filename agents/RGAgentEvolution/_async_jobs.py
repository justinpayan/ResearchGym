    ...
    async def execute(cmd: str, workdir: Optional[str] = None) -> str:
        ...
        try:
            ...
            with open(log_path, "w", encoding="utf-8") as handle:
                # Keep the child in its own process group/session so stray console
                # CTRL+C/CTRL+BREAK events don't bubble in as KeyboardInterrupt.
                # Cancellation should only occur through cancel_async().
                creationflags = 0
