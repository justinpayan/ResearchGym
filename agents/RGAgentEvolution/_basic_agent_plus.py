...
HANDOFF_TOKEN_THRESHOLD_DEFAULT = 125_000
...
EXTENDED_CONTINUE_MESSAGE = (
    "Please proceed to the next step using your best judgement. You should always strive to improve performance further, "
    "if you have ideas on how to improve the current proposed solution, you can do that. Otherwise, if you feel the current "
    "solution is sub-optimal, feel free to propose completely new ideas to improve performance further. If you are absolutely "
    "sure you are done, double-check everything before you end the task."
)
    ...
    **kwargs: Unpack[BasicAgentDeprecatedArgs],
    ...
    def _log_reasoning_usage(output: ModelOutput) -> None:
        try:
            ...
            cache_str = f", cache_read={cache_read:,}" if isinstance(cache_read, int) else ""
            print(
    ...
    # Wrap basic_agent_loop to add transcript persistence and metadata streaming
