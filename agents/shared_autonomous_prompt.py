...
AUTONOMOUS_PROMPT_TEMPLATE = Template(
    """
ADDITIONAL NOTES
------
...
def render_autonomous_prompt(
    *,
    type_of_processor: str,
    max_time_in_hours: float | int,
    idea_hint_note: str = "",
    literature_line: str = "",
    hypothesis_line: str = "",
    multiple_hypotheses_line: str = "",
) -> str:
    return AUTONOMOUS_PROMPT_TEMPLATE.substitute(
        idea_hint_note=idea_hint_note,
        type_of_processor=type_of_processor,
        max_time_in_hours=max_time_in_hours,
        literature_line=literature_line,
        hypothesis_line=hypothesis_line,
        multiple_hypotheses_line=multiple_hypotheses_line,
    ).strip()
