...
- **Environments**: DeepMind Control Suite (DMC) for state-based (Quadruped-Walk, Cheetah-Run, Reacher-Hard, Finger-Turn-Hard) and pixel-based (Walker-Walk, Cheetah-Run) tasks results averaged over 5 seeds. OpenAI Gym for state-based tasks (Walker2d-v2, HalfCheetah-v2, Hopper-v2), results are averaged over 3 seeds.. Randomized DMLab environments for stochasticity experiments.
